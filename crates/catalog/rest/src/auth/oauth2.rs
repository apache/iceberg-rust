...
use crate::catalog::{
    RestCatalogConfig, credential_from_props, extra_headers_from_props, oauth_params_from_props,
};
...
impl OAuth2Manager {
    ...
    /// Sets extra OAuth2 form parameters (e.g. `scope`, `audience`).
    pub fn with_extra_oauth_params(mut self, params: HashMap<String, String>) -> Self {
        self.init_params.extra_oauth_params = params;
        self
    }
...
impl AuthManager for OAuth2Manager {
    ...
    async fn catalog_session(
        ...
        Ok(Arc::new(OAuth2Session {
            ...
            token: self.token.clone(),
            params: OAuth2Params {
                extra_headers: extra_headers_from_props(props)?,
                token_endpoint: props
                ...
                extra_oauth_params: oauth_params_from_props(props),
            },
        }))
    }
}
