...
mod tests {
    ...
    async fn test_with_custom_credential_loader() {
        ...
        #[derive(Debug)]
        struct RustfsCredentialLoader;

        impl ProvideCredential for RustfsCredentialLoader {
        ...
        let factory = OpenDalResolvingStorageFactory::new()
            .with_s3_credential_loader(CustomAwsCredentialLoader::new(RustfsCredentialLoader));
