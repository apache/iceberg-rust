...
/// Defaults to 32 MiB, matching Java `S3FileIOProperties.MULTIPART_SIZE_DEFAULT`.
///
...
///
/// Java stores this property in an `int` and its `S3FileIOProperties` javadoc asks for
