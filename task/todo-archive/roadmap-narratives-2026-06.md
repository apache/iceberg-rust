...
# Roadmap narratives — full pre-de-triplication Roadmap.md, archived verbatim 2026-06-10

The COMPLETE `Roadmap.md` as it stood before sprint increment D (status de-triplication) rewrote it
lean. Every per-increment narrative paragraph that used to live in the Roadmap is preserved here
verbatim — grep on demand, not required reading. The live [../../Roadmap.md](../../Roadmap.md) now
holds the plan; per-capability STATUS lives only in
