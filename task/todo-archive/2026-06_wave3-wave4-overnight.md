...
# Todo archive — 2026-06 Waves 3–4 + the 2026-06-12 overnight session (archival pass 3)

Increment plans/outcomes moved verbatim by todo-archival pass 3 (2026-06-12, size trigger —
2,358 lines). NOT phase-filed: the pass spans phases 2/3/4/6 + interop/harness + doc-ops work
landed across PRs #25–#37 in one three-day burst; one pass-scoped file keeps the provenance
together (the pass-2 ops-hardening precedent). Every section's work is MERGED; unticked boxes
riding these sections were stale-audited at pass time (all landed or named as GAP_MATRIX
deferrals). The superseded wave-charter planning section is at the end. Not session-start
