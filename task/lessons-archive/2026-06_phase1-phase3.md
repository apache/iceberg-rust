...
_promoted 2026-06-09 → crates/iceberg/src/transaction/map.md#debug_
...
_promoted 2026-06-09 → crates/iceberg/src/transaction/map.md#debug (first checks)_
...
_promoted 2026-06-09 → docs/testing.md (interaction branches)_
...
_promoted 2026-06-09 → crates/iceberg/tests/map.md#debug_
...
_promoted 2026-06-09 → dev/java-interop/map.md#debug_
...
_promoted 2026-06-09 → crates/iceberg/src/transaction/map.md#debug (choke-point guards)_
...
_promoted 2026-06-09 → docs/testing.md (mutate both directions)_
...
_promoted 2026-06-09 → docs/testing.md (unpinned divergence; git stash check)_
...
_promoted 2026-06-09 → dev/java-interop/map.md#debug (drive real Java objects)_
...
_promoted 2026-06-09 → docs/testing.md (public-entry-point negative test)_
...
_promoted 2026-06-09 → dev/java-interop/map.md#debug (re-parsed base; fixture churn)_
...
_promoted 2026-06-09 → docs/testing.md (pin boundaries ON the boundary)_
...
_promoted 2026-06-09 → docs/testing.md (verify-then-fix; probes become named tests)_
...
_promoted 2026-06-09 → docs/testing.md (post-commit scan live-set pin)_
...
_promoted 2026-06-09 → docs/testing.md + crates/iceberg/src/transaction/map.md#debug (cross-snapshot provenance)_
...
_promoted 2026-06-09 → docs/testing.md (cumulative multi-commit totals)_
...
_promoted 2026-06-09 → docs/testing.md (mutation backup mechanics)_
...
_promoted 2026-06-09 → crates/iceberg/src/writer/map.md#debug (position-vs-field-id read contracts)_
...
_promoted 2026-06-09 → crates/iceberg/src/transaction/map.md#debug (conflict-validation pattern)_
...
_promoted 2026-06-09 → docs/testing.md + crates/iceberg/src/transaction/map.md (no-override tx-captured-start test)_
...
_promoted 2026-06-09 → crates/iceberg/src/inspect/map.md#debug (arrow struct/map builder rules)_
...
_promoted 2026-06-09 → crates/iceberg/src/inspect/map.md#debug (boxed child builders)_
...
_promoted 2026-06-09 → crates/iceberg/src/inspect/map.md#debug (add_entry restamps snapshot_id)_
...
_promoted 2026-06-09 → docs/testing.md (workspace build gate for cross-crate changes)_
...
_promoted 2026-06-09 → crates/iceberg/src/inspect/map.md#debug (Java required flags are nominal)_
...
_promoted 2026-06-09 → crates/iceberg/src/scan/map.md#debug (file-own-spec vs default-spec mutation)_
...
_promoted 2026-06-09 → docs/testing.md (shared-helper cross-consumer mutation)_
...
_promoted 2026-06-09 → docs/testing.md (N sources need N distinct values)_
...
_promoted 2026-06-09 → docs/testing.md (never git-checkout a dirty tracked file)_
...
_promoted 2026-06-09 → CLAUDE.md "Working conventions" (gate chained to commit)_
