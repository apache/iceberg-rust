...
# Lessons archive — 2026-06 Waves 3–4 + the 2026-06-12 overnight session (pass 3)

Verbatim entries archived by compaction pass 3 (2026-06-12, size trigger — 2,292 lines vs the
~800-line trigger). Covers: the Phase-2/3 closeout remnants (2026-06-08→10 entries kept live by
pass 2), the DV/cherrypick/carried-forward arcs, multi-spec writes + constants-map activation,
ExpireSnapshots B1/B2 + A3 interop, DeleteOrphanFiles A1/A2, the variant arc B1/B2 + F1/F2
(builder halves), Wave-4 O1–O3 (builder halves), the S1–S3 Sonnet interop arc, V2 (builder), and
W1/W2 (superseded/process halves). Entries are verbatim; promotion stubs mark rules lifted to
canonical homes. Not session-start reading — grep on demand.
...
_promoted 2026-06-12 → docs/testing.md (writer-generated fixtures inherit canonical shape — hand-build disordered/non-canonical fixtures for layout/order claims)_
...
_promoted 2026-06-12 → docs/testing.md (a sabotage/guard pin must corrupt the artifact under test, run a clean control first, and be proven able to fire; `is_err()` alone never pins fail-fast/atomicity)_
...
_promoted 2026-06-12 → dev/java-interop/map.md#debug (projection-completeness: data-level row compares must cover EVERY schema column incl. partition columns, on BOTH language sides)_
...
_promoted 2026-06-12 → docs/testing.md (writer-generated fixtures inherit canonical shape)_
...
_promoted 2026-06-12 → docs/testing.md (sabotage must corrupt the artifact + control-first) + dev/java-interop/map.md#debug (projection on both sides)_
